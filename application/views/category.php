...
<html>
<head>
	<title><?php echo html_escape(getCatNameBySlug($catPosts[0]->book_category)) . " Kategorisindeki Kitaplar " .$settings[0]->set_suffix; ?></title>
	<meta charset="utf-8" />
			...
			<div id="banner" class="box container">
				<div class="row">
					<div class="col-12 col-12-medium">
						<h2><?php echo html_escape(getCatNameBySlug($catPosts[0]->book_category)); ?></h2>
						<p>Kategorisindeki kitaplar listeleniyor</p>
					</div>
				</div>
			</div>
		</div>
